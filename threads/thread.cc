...
#ifdef LAB1
void LivingThreadStatus() {
    DEBUG('t', "Print living thread status\n");
    printf("TID\tUID\tSTATUS\t      NAME\n");
    LivingThreadPool->Mapcar((VoidFunctionPtr) ThreadPrint);
    return;
}
#endif
